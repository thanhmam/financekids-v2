...
function getWeekStatus(streak) {
  // Mark the last `streak` days (up to 7) as done; last day (today) optional
    ...
    <div style={{ minHeight: "100vh", background: "#F4F8EF", paddingBottom: 80 }}>
      ...
      <div style={{ padding: "16px 18px 0" }}>
        ...
        <div style={{
          ...
          borderRadius: 24, padding: "20px 18px", textAlign: "center",
          color: "#fff", marginBottom: 16, boxShadow: "0 6px 0 #E0631C",
        }}>
          <div style={{ font: "800 64px 'Baloo 2'", lineHeight: 1, textShadow: "0 3px 0 rgba(0,0,0,.15)" }}>
            {streak}
          </div>
          <div style={{ font: "800 20px 'Baloo 2'", marginTop: 2 }}>ngày streak!</div>
          <div style={{ font: "700 13px 'Nunito'", color: "rgba(255,255,255,.9)", marginTop: 4 }}>
            Giữ phong độ — bạn đang làm rất tốt
          </div>
        </div>
        ...
        <div style={{
          ...
          marginBottom: 16, border: "2px solid #ECF1E6",
        }}>
          {DAYS.map((day, i) => {
            ...
            return (
              <div key={day} style={{ textAlign: "center" }}>
                <div style={{
                  ...
                  background: done ? "#FF8A3D" : "#fff",
                  border: isToday && !done ? "2.5px dashed #FFB877" : done ? "none" : "2px solid #ECF1E6",
                  color: done ? "#fff" : isToday ? "#FF8A3D" : "#C2CDBA",
                ...
                <div style={{
                  font: isToday ? "800 10px 'Nunito'" : "700 10px 'Nunito'",
                  color: done ? "#FF8A3D" : isToday ? "#FF8A3D" : "#9AA89E",
                  marginTop: 5,
                }}>
                  {day}
                </div>
        ...
        {/* Rewards section */}
        <div style={{ font: "800 16px 'Baloo 2'", color: "#15392A", marginBottom: 10 }}>
          Phần thưởng
        </div>

        {/* Reward item — 7-day milestone */}
        <div style={{
          display: "flex", alignItems: "center", gap: 12,
          background: "#fff", borderRadius: 16, padding: 12,
          border: "2px solid #ECF1E6", marginBottom: 10,
        }}>
          ...
          {streak >= 7 ? (
            <button className="btn-press" style={{ background: "#16C172", color: "#fff", borderRadius: 12, padding: "7px 14px", font: "800 12px 'Baloo 2'", border: "none", cursor: "pointer", boxShadow: "0 3px 0 #0E9E5C" }}>
              NHẬN
            </button>
          ) : (
            <div style={{ background: "#F4F8EF", color: "#9AA89E", borderRadius: 12, padding: "7px 12px", font: "800 12px 'Baloo 2'" }}>
              {streak}/7
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          <div style={{ width: 44, height: 44, borderRadius: 12, background: "#E9F3FF", display: "flex", alignItems: "center", justifyContent: "center", color: "#2BA3FF", font: "800 20px 'Baloo 2'" }}>
            ❄
          </div>
          <div style={{ flex: 1 }}>
          ...
          <button
            ...
            style={{ background: "#fff", border: "2px solid #DDE6D6", color: "#5B7065", borderRadius: 12, padding: "7px 12px", font: "800 12px 'Baloo 2'", cursor: "pointer" }}
          >
            120 xu
          </button>
        </div>
        ...
        <div style={{
          ...
          <div style={{ width: 44, height: 44, borderRadius: 12, background: "#FFF3DC", display: "flex", alignItems: "center", justifyContent: "center", color: "#FF8A3D", font: "800 22px 'Baloo 2'" }}>
            ▲
          </div>
          <div style={{ flex: 1 }}>
