...
const BENEFITS = [
  ...
  { emoji: "⏱️", title: "Tiết kiệm thời gian", desc: "Không lạc lối giữa 45 bài — XuXu chọn sẵn cho bạn." },
        ...
        {step === "intro" && (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ font: "600 15px/1.6 'Nunito'", color: C.muted, maxWidth: 460, margin: "0 auto 24px" }}>
              Trả lời 3 câu hỏi nhanh, XuXu sẽ chọn đúng những bài học phù hợp với mục tiêu và trình độ của bạn.
            </p>
