 ...
 */
export function XuXuMascot({ size = 56, mood = "happy", float = false, style }) {
  const s = size;
  ...
  if (mood === "sad") {
    return (
      <div style={{ ...wrap, background: "radial-gradient(circle at 38% 30%,#FFE594,#FFC93C 58%,#F2B01E)", border: `${border}px solid #C99A22`, boxShadow: `0 ${shadow}px 0 #A87E12` }}>
  ...
  if (mood === "excited") {
    return (
      <div style={{ ...wrap, background: "radial-gradient(circle at 38% 30%,#FFE594,#FFC93C 58%,#F2B01E)", border: `${border}px solid #E8A317`, boxShadow: `0 ${shadow}px 0 #C98A12` }}>
